...
# Define some controllers to pass to ThreadedCommandFactory.  Note that the
...
cmd1 = cmd_factory.create_threads(lambda controller, search_term: controller.do_search(search_term), search_command_1)
cmd2 = cmd_factory.create_threads(lambda controller, search_term: controller.do_search(search_term), search_command_2)
